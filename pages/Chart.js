...
class CandleStickChartWithMACDIndicator extends React.Component {
  render() {
    ...
    const calculatedData = smaVolume50(
      macdCalculator(ema11(ema22(initialData)))
    );
    ...
    return (
      ...
      >
        ...
        >
          ...
          <CandlestickSeries />
          <LineSeries yAccessor={ema22.accessor()} stroke={ema22.stroke()} />
          <LineSeries yAccessor={ema11.accessor()} stroke={ema11.stroke()} />

          <CurrentCoordinate
            yAccessor={ema22.accessor()}
            fill={ema22.stroke()}
          />
          <CurrentCoordinate
            yAccessor={ema11.accessor()}
            fill={ema11.stroke()}
          />
            ...
            options={[
              {
                ...
                type: "EMA",
                stroke: ema22.stroke(),
                windowSize: ema22.options().windowSize,
              },
              {
                yAccessor: ema11.accessor(),
                type: "EMA",
                stroke: ema11.stroke(),
                windowSize: ema11.options().windowSize,
              },
            ]}
          />
        </Chart>
